namespace QuanLyKS.All_User_Control
{
    partial class UC_CheckOut
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Font = new Font("Segoe UI", 10.8F, FontStyle.Italic, GraphicsUnit.Point, 163);
            label2.ForeColor = Color.Black;
            label2.Location = new Point(605, 94);
            label2.Name = "label2";
            ...
            txtName.Location = new Point(605, 134);
            txtName.Margin = new Padding(4, 5, 4, 5);
            txtName.Name = "txtName";
            txtName.PasswordChar = '\0';
            txtName.PlaceholderText = "Enter FullName";
            txtName.SelectedText = "";
            txtName.ShadowDecoration.CustomizableEdges = customizableEdges2;
            txtName.Size = new Size(572, 80);
            ...
            guna2DataGridView1.Location = new Point(63, 241);
            ...
            label3.Font = new Font("Segoe UI", 10.8F, FontStyle.Italic, GraphicsUnit.Point, 163);
            label3.ForeColor = Color.Black;
            label3.Location = new Point(33, 636);
            label3.Name = "label3";
            ...
            label4.Font = new Font("Segoe UI", 10.8F, FontStyle.Italic, GraphicsUnit.Point, 163);
            label4.ForeColor = Color.Black;
            label4.Location = new Point(635, 636);
            label4.Name = "label4";
            ...
            label5.Font = new Font("Segoe UI", 10.8F, FontStyle.Italic, GraphicsUnit.Point, 163);
            label5.ForeColor = Color.Black;
            label5.Location = new Point(1236, 636);
            label5.Name = "label5";
            ...
            txtCheckOutDate.CustomizableEdges = customizableEdges7;
            txtCheckOutDate.Font = new Font("Segoe UI", 9F);
            txtCheckOutDate.Format = DateTimePickerFormat.Short;
            txtCheckOutDate.Location = new Point(1236, 676);
            ...
            txtCheckOutDate.ShadowDecoration.CustomizableEdges = customizableEdges8;
            txtCheckOutDate.Size = new Size(319, 80);
            txtCheckOutDate.TabIndex = 10;
            txtCheckOutDate.Value = new DateTime(2024, 8, 4, 17, 45, 26, 649);
            // 
            // btnCheckOut
            // 
            ...
            btnCheckOut.Font = new Font("Segoe UI", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 163);
            btnCheckOut.ForeColor = Color.Black;
            btnCheckOut.Location = new Point(1589, 676);
            btnCheckOut.Name = "btnCheckOut";
            btnCheckOut.ShadowDecoration.CustomizableEdges = customizableEdges10;
            btnCheckOut.Size = new Size(233, 80);
